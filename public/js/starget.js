    ...
    can(permission) {
      ...
      const map = {
        ...
        doc_manager: ['dashboard.view','clients.view','clients.create','clients.edit',
          ...
          'tasks.view','tasks.close','applications.view',
        ...
        logistic_manager: ['dashboard.view',
            'applications.view',
  ...
  fmt: {
    ...
    status(s) {
      const m = {
        ...
        client_refusal: { label: 'Отменено',     cls: 'badge-danger' },
        our_refusal:    { label: 'Отменено',     cls: 'badge-danger' },
        mutual_refusal: { label: 'Отменено',     cls: 'badge-danger' },
        logistic_refusal:{ label: 'Отменено',    cls: 'badge-danger' },
